...
public class DeclaracionReporteConstacia extends BasePage {
    ...
    public DeclaracionReporteConstacia(Page page) {
        super(page);
    ...
    public void assertLoaded() {
        ...
        log.info("[DECLARACION][NUMERO DE CONSTANCIA]: {}", numeroConstanciaLabel.innerText());
    }
