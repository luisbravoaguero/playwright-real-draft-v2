...
public class ConsultaDocumentoAccidentesPage extends BasePage {
    ...
    public ConsultaDocumentoAccidentesPage(com.microsoft.playwright.Page page) {
        super(page);
        this.title = page.getByRole(AriaRole.HEADING, new Page.GetByRoleOptions().setName("Documentos accidentes"));
    ...
    public void assertLoaded() {
        ElementAsserts.assertVisible(title, "TITULO Documentos accidentes DEBE SER VISIBLE");
    }
    public void fillFormDocumentosAccidentes(String fecha_inicio, String fecha_fin) {
    ...
    public void validateDateRange() {
        ...
        while (true) {
            ...
            for (int i = 0; i < filasResultados.count(); i++) {
                ...
                RegistroFechaAccidentes registro = new RegistroFechaAccidentes(numDoc, fechaTexto);
