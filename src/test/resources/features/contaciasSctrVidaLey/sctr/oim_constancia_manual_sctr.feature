...
Feature: Constancia manual de una poliza sctr para pension o salud
  @constanciamanualsctrpensionsalud @constanciamanualsctrpensionsaludmesadelantado @migracionconstanciamanualsctrpensionsalud
  Scenario Outline: Constancia Manual de una poliza sctr para pension y salud mes adelantado
