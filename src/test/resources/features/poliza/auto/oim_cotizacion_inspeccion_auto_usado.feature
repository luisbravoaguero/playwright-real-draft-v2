...
Feature: Emision de una poliza de auto
  @cotizacioninspeccionautousado
  Scenario Outline: Cotizacion e inspeccion de poliza auto usado
 ...
 #When en la pagina Nueva Solicitud de Inspeccion, en el paso Solicitante y vehiculo, en la seccion Informacion del solicitante completamos el correo electronico y  en la seccion Datos del vehiculo completamoe el numero de placa, serie y cantidad de accesorios
    ...
    #los datos que dicen opcional no son requeridos, se generan en la cotizacion
    ...
    Examples:
      ...
      | OPCIONAL         |OPCIONAL               |OPCIONAL            |OPCIONAL      |OPCIONAL    |OPCIONAL    | TOYOTA YARIS| 2020             | AUTOMOVIL    | DNI           |99762332        | JOSE   | ROJAS      | COLCAS     | 19/08/1993       | EXTLUBA@MAPFRE.COM.PE| MASCULINO| LIMA         |LIMA       | COMAS    | DORADA / PREMIUM I | PARTICULAR|3        |
