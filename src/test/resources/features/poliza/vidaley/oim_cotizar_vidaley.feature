...
Feature: cotizar poliza vida ley

  @cotizacionvidaley @q2 @q2sprint1 @cotizacionvidaleyruccoberturadocemeses @atprimergrupo
  Scenario Outline: Cotizacion de una poliza vida ley con RUC y cobertura mensual de doce meses
    ...
    Examples:
      ...
      |RUC             |20534162686     |AUTOMATIZACION  |945586698      |drpruebas@hotmail.com|3220     |ANUAL                 |14/04/2026   |12 MESES          |MAPFRE       |