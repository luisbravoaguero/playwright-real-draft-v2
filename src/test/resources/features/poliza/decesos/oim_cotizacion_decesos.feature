@regresion @decesos
Feature: Cotizacion  de una poliza de decesos
  @cotizaciondeceso
  Scenario Outline: Cotizacion de una poliza de decesos con DNI
  ...
  Examples:
    |producto         |poliza_grupo                 |modalidad              |medio_pago|tipo_documento|numero_documento|estado_civil|profesion|telefono_casa|telefono_movil|correo_electronico   |departamento |provincia |distrito |tipo_via |nombre_via  |numero |enumeracion |tipo_documento2|numero_documento2|
    |seguro de sepelio| INTEGRAL (BAS/6TO/CLASIC 2017) |Plan Integral - 3 Aseg.|Cobradores|DNI           |11111111| SOLTERO | ADMINISTRADOR |5287449|981502678|pruebas89@gmail.com|LIMA|LIMA|COMAS| AVDA. |UNIVERSITARIA| NRO |1234| DNI |22222222|
